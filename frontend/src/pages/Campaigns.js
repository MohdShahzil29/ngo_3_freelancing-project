...
const Campaigns = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 py-12" data-testid="campaigns-page">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {campaigns.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-stone-600">कोई सक्रिय अभियान नहीं है। जल्द ही नए अभियान शुरू होंगे।</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-stone-500">
                    {Math.round((campaign.current_amount / campaign.goal_amount) * 100)}% completed
                  </p>
                </div>
              </motion.div>
            ))}
